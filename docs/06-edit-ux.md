...
propagation); single-file diff preview with Apply/Discard. Multi-file rename uses sequential
diff preview (`1/N`); full Refactor Preview panel deferred to Phase 4 (`P4-3`).
